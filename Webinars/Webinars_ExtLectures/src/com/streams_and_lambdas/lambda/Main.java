package com.streams_and_lambdas.lambda;
...
//		};
		...
		//Way 3 -> Lambda Expression starting from Java 8
		// Boiler plate of lambda expression : () -> {}
		//() = input parameters
		// -> = separation between i/p and o/p
		//{} = implementation
		
		//Because we know that the functional interfaces can only have one abstract method
		//we don't need to define the method's name when we are calling it
        ...
        //System.out.println(predicate1.test("Check this string"));
...
//        }
        ...
        //System.out.println(biFunction.apply("String1", "String2"));
