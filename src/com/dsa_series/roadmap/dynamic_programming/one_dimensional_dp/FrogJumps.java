...
public class FrogJumps {
    ...
    public int frogJump_BF(int[] heights) {
        return frogJump(heights, heights.length - 1);
    }

    public int frogJump(int[] heights, int index) {
        if (index == 0)
            return 0;
    ...
    public int frogJump_Tabulation(int[] heights) {
        int n = heights.length;
        if (n == 1)
            return 0;
        if (n == 2)
    ...
    public int frogJump_Tabulation_SpaceOptimised(int[] heights) {
        int n = heights.length;
        if (n == 1)
            return 0;
        if (n == 2)
